...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2024 at 08:35 PM
...
INSERT INTO `orders` (`email`, `number`, `address`, `date`, `totalbill`, `order_id`, `uid`) VALUES
('', 2147483647, 'Nazimabad', '2024-02-21', 576, 28, 1);
...
(1, 'Sufi', 'Nadeem', 'sufi@gmail.com', '124'),
(7, 'arham', 'sohail', 'arhamsohail@gmail.com', '123'),
(8, 'ebad', 'naeem', 'ebad@gmail.com', '124'),
(9, 'Fasi', 'Naeem', 'fasi@gmail.com', '123'),
(23, 'Taha', 'Khan', 'taha@gmail.com', '12345678');
...
--
ALTER TABLE `wishlist`
  MODIFY `wid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=203;
COMMIT;
