    ...
    if(($_REQUEST['product_id'] == "") || ($_REQUEST['product_title'] == "") || ($_REQUEST['product_desc'] == "") || ($_REQUEST['product_price'] == "") || ($_REQUEST['product_quantity'] == "") || ($_REQUEST['status'] == "")){
        ...
        if(empty($pro_image)) {
            if(count($pro_image)==4) {
                $sql = "UPDATE `products` SET `product_title`='$product_title', `product_desc`='$product_desc', `Cate_id`='$Cate_id', `product_price`='$product_price', `status`='$status', `product_label`='$product_label', `product_img1`='$pro_image[0]', `product_img2`='$pro_image[1]', `product_img3`='$pro_image[2]', `product_img4`='$pro_image[3]', `product_quantity`='$product_quantity' WHERE product_id = $product_id";
            } else if(count($pro_image)==3) {
                $sql = "UPDATE `products` SET `product_title`='$product_title', `product_desc`='$product_desc', `Cate_id`='$Cate_id', `product_price`='$product_price', `status`='$status', `product_label`='$product_label', `product_img1`='$pro_image[0]', `product_img2`='$pro_image[1]', `product_img3`='$pro_image[2]', `product_quantity`='$product_quantity' WHERE product_id = $product_id";
            } else if(count($pro_image)==2) {
                $sql = "UPDATE `products` SET `product_title`='$product_title', `product_desc`='$product_desc', `Cate_id`='$Cate_id', `product_price`='$product_price', `status`='$status', `product_label`='$product_label', `product_img1`='$pro_image[0]', `product_img2`='$pro_image[1]', `product_quantity`='$product_quantity' WHERE product_id = $product_id";
            } else if(count($pro_image)==1) {
                $sql = "UPDATE `products` SET `product_title`='$product_title', `product_desc`='$product_desc', `Cate_id`='$Cate_id', `product_price`='$product_price', `status`='$status', `product_label`='$product_label', `product_img1`='$pro_image[0]', `product_quantity`='$product_quantity' WHERE product_id = $product_id";
            }
        } else {
            $sql = "UPDATE `products` SET `product_title`='$product_title', `product_desc`='$product_desc', `Cate_id`='$Cate_id', `product_price`='$product_price', `status`='$status', `product_label`='$product_label', `product_quantity`='$product_quantity'  WHERE product_id = $product_id";
        }
