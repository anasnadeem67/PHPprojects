...
<body>
    <!--- Top Navbar --->
    <nav class="navbar navbar-dark fixed-top bg-warning flex-md-nowrap p-0 shadow"><a class="navbar-brand col-sm-3 col-md-2 mr-0" href="Employee_Dashboard.php">Happy Stationary</a></nav>
...
<ul class="nav flex-column">
    <li class="nav-item"><a class="nav-link <?php if(PAGE == 'Employee_Dashboard'){echo 'active';} ?>" href="Employee_Dashboard.php"><i class="fa-solid fa-user mr-1"></i>Dashboard</a></li>
    ...
    <li class="nav-item"><a class="nav-link <?php if(PAGE == 'EmpChangePass'){echo 'active';} ?>" href="EmpChangePass.php"><i class="fa-solid fa-key mr-1"></i>Change Password</a></li>
