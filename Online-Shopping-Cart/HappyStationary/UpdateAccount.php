...
if(isset($_REQUEST['proupdate'])){
    if(($_REQUEST['first_name'] == "") || ($_REQUEST['last_name'] == "") || ($_REQUEST['email'] == "")){
        ...
        $sql = "UPDATE `users` SET `first_name`='$first_name', `last_name`='$last_name', `email`='$email' where email = '$user'";
...
<form class="Reg" action="" method="POST">
  ...
  <p>Update Your Profile Information.</p>
    ...
    <input type="text" class="form-control" id="first_name" name="first_name" value="<?php if(isset($row['first_name'])) { echo $row['first_name']; } ?>">
  </div>
</div>
<div class="row">
  <div class="form-group w-75">
    <label for="last_name">Last Name</label>
    <input type="text" class="form-control" id="last_name" name="last_name" value="<?php if(isset($row['last_name'])) { echo $row['last_name']; } ?>">
  </div>
  </div>
  <div class="row">
  <div class="form-group w-75">
    ...
    <button type="Submit" class="action-btn" name="proupdate">Update</button>
</form>
