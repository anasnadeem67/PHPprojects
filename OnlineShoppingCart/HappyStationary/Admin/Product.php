    ...
    <tbody>
       <?php while($row = $result->fetch_assoc()){
        echo '<tr>';
         ...
         echo '<td><img src="'.$row['product_img1'].'" width="100px" height="100px"</td>';
         echo '<td><img src="'.$row['product_img2'].'" width="100px" height="100px"</td>';
         echo '<td><img src="'.$row['product_img3'].'" width="100px" height="100px"</td>';
         echo '<td><img src="'.$row['product_img4'].'" width="100px" height="100px"</td>';
